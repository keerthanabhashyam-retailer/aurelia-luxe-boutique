...
export const CATEGORIES: string[] = ['Rings', 'Earrings', 'Bangles', 'Bracelets', 'Necklace', 'Pendants'];

export const OFFERS = [
  "✨ Summer Sale: Up to 30% off on all Diamond Rings! ✨",
  "💍 New Collection: The 'Aura Bloom' necklace is now available! 💍",
  "🚚 Free shipping on all orders over ₹50,000! 🚚",
  "🎁 Get a complimentary jewelry cleaning kit with every purchase! 🎁"
];
...
export const Icons = {
  ...
  Check: () => <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-green-500" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" /></svg>,
